        ...
        <section className="bg-orange-50 py-20">
            <div className="max-w-[1920px] mx-auto xl:px-28 md:px-10 px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center justify-between">
                    <div className="">
                        <Fade delay={1e2} cascade damping={1e-1}><h3 className='text-3xl md:text-5xl text-black font-bold md:font-semibold  mb-4'>About <span className='text-primary'>Us</span></h3></Fade>
