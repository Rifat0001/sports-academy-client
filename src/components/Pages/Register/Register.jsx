            ...
            .then((result) => {
                ...
                updateUserProfile(data.name, data.photoURL)
                    .then(() => {
                        ...
                        fetch("https://myapp-nine-iota.vercel.app/users", {
                            method: "POST",
                            headers: {
                ...
                <div>
                    <form className="card-body" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="form-control mt-6">
                            <input
                                type="submit"
                                className={`btn btn-primary ${!isDirty || confirm_password !== password
                    ...
                    <div className="text-center card-body">
                        ...
                        <p>
                            Already have an account? Please<Link to="/login" className="text-primary font-bold"> Login</Link>
                        </p>
                    </div>
                </div>
            </div>
